# configurable-schema-gui-fixes (Plan)

- **Issue:** #60
- **Parent (optional):** none
- **Owner:** drmoisan
- **Last Updated:** 2026-06-09T10-50
- **Status:** Draft
- **Version:** 0.1
...
- [ ] [P2-T1] [expect-fail] Add a small, deterministic regression test in the standard module file (use `tests/bugs/<YYYY>/#60-<desc>.py` only if no clear home exists)
